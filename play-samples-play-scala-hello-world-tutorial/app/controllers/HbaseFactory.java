...
public class HbaseFactory {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // https://docs.oracle.com/javase/tutorial/essential/exceptions/tryResourceClose.html)
            Table table = connection.getTable(TableName.valueOf("shopping"));
            System.out.print("hbase");
            try {
                ...
                p.addColumn(Bytes.toBytes("product"), Bytes.toBytes("name"),
                        Bytes.toBytes("shoes"));
                ...
                Delete d = new Delete(Bytes.toBytes("r2"));
                d.addFamily(Bytes.toBytes("product"));
                table.delete(d);

                Get g = new Get(Bytes.toBytes("r2"));
                Result r = table.get(g);
                byte [] value = r.getValue(Bytes.toBytes("product"),
                        Bytes.toBytes("name"));
                ...
                Scan s = new Scan();
                s.addColumn(Bytes.toBytes("product"), Bytes.toBytes("name"));
